...
export const results = {
  ...
  semesters: [
    { sem: 1, sgpa: 8.2, subjects: [
      ...
      { name: "C Programming", grade: "A", credits: 4 },
      { name: "English Communication Skills", grade: "B+", credits: 3 },
      { name: "Digital Logic and Design", grade: "A+", credits: 4 },
      { name: "Data Structure and Algorithms", grade: "A", credits: 4 },
    ]},
    { sem: 2, sgpa: 8.5, subjects: [
      { name: "Database Management System", grade: "A+", credits: 4 },
    ...
    { sem: 3, sgpa: 8.6, subjects: [
      ...
      { name: "Introduction to AI", grade: "A", credits: 4 },
      { name: "Probability and Statistics", grade: "A", credits: 3 },
      { name: "Python Programming", grade: "A+", credits: 4 },
      { name: "Design Thinking", grade: "B+", credits: 3 },
    ]},
  ],
};
