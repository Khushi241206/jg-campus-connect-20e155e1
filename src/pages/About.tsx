    ...
    <div className="space-y-6 animate-fade-in max-w-3xl">
      ...
      >
        <div className="flex items-center gap-4 mb-4">
          <div className="h-14 w-14 rounded-xl overflow-hidden border border-border shadow-md shrink-0">
            <img src={jgLogo} alt="JG University" className="h-full w-full object-cover" />
          </div>
          <div>
